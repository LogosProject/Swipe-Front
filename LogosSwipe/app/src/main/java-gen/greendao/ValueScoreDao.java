...
/** 
 * DAO for table VALUE_SCORE.
*/
public class ValueScoreDao extends AbstractDao<ValueScore, Long> {

    public static final String TABLENAME = "VALUE_SCORE";

    /**
     * Properties of entity ValueScore.<br/>
    ...
    */
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'VALUE_SCORE'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, ValueScore entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(ValueScore entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(ValueScore entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
