    ...
    */
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM SOLUTION T");
    ...
    protected Solution loadCurrentDeep(Cursor cursor, boolean lock) {
        Solution entity = loadCurrent(cursor, 0, lock);
    ...
    public Solution loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<Solution> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<Solution> list = new ArrayList<Solution>(count);
    ...
    protected List<Solution> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<Solution> queryDeep(String where, String... selectionArg) {
